...
.palette-enter-active {
  transition: width 275ms cubic-bezier(0.4, 0.0, 0.6, 1) 0ms,height 300ms cubic-bezier(0.4, 0.0, 0.6, 1) 35ms,box-shadow 275ms cubic-bezier(0.4, 0.0, 0.6, 1) 0ms, opacity 375ms cubic-bezier(0.4,0,0.6,1);
}
